<?php
  ...
  $conditions = ["b.nama_bidang = 'Pimpinan'"];
  $params = [];
  $types = '';
      ...
      <form action="" method="GET" class="w-full">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <a href="dataTabelTamuPimpinan.php" class="text-sm text-gray-600 hover:text-gray-900 px-3 py-2 bg-gray-200 rounded-lg">Reset</a>
          </div>
        </div>
      </form>

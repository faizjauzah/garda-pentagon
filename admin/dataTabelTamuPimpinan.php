<?php
  ...
  // --- QUERY UNTUK MENGAMBIL DATA SESUAI PERMINTAAN ---
  ...
  $sql = "SELECT 
          ...
          WHERE
              b.nama_bidang = 'Pimpinan' -- Tetap filter hanya untuk pimpinan
          ORDER BY 
...
<html lang="id">
  <head>
    ...
    <title>Presensi Tamu Pimpinan</title>
  ...
  <body class="bg-[#f3f3f3] w-full min-h-screen flex flex-col lg:flex-row">
    ...
    <main class="flex flex-col w-full px-4 py-6 lg:py-10 gap-6">
      <header class="flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-[#131313]">Presensi Tamu Pimpinan</h1>
          ...
          <table class="w-full text-left">
            ...
            <tbody class="text-sm text-gray-700">
              ...
              <?php
                ...
                echo '<tr><td colspan="9" class="p-4 text-center text-gray-500">Belum ada data tamu.</td></tr>';
              }
              ?>
            </tbody>
          </table>
